  ...
  return (
    <>
      <div className="relative">
        <Image src="/Images/Contact.png" alt="Picture of the author"width={1440}height={316} />
      ...
      <div className=" mt-5 mb-5 flex justify-evenly items-center p-2 w-[100%] h-[8rem] bg-[#F9F1E7]">
        ...
        <Image src="/Images/HighQuality.png" width={40} height={40} alt="Picture of the author" />
        
          <h4 className="font-bold">High Quality</h4>
          <p>crafted from top materials</p>
        </div>
        <div>
        <Image src="/Images/Warranty.png" width={40} height={40} alt="Picture of the author" />
          <h4 className="font-bold">Warranty Protection</h4>
          <p>Over 2 years</p>
        </div>
        <div>
        <Image src="/Images/Shipping.png" width={40} height={40} alt="Picture of the author" />
          <h4 className="font-bold">Free Shipping</h4>
          <p>Order over 150 $</p>
        </div>
        <div>
        <Image src="/Images/24hrs.png" width={40} height={40} alt="Picture of the author" />
