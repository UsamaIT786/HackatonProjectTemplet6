  ...
  return (
    <>
      <div className="relative">
        <Image src="/Images/cart.png" alt="Picture of the author" width={1440}height={316} />
...
<div className="flex justify-evenly gap-1">
            <Image src="/Images/chairs.png" width={200} height={105} alt="Picture of the author" />
            <p>Asgaard sofa</p>
            <p>Rs. 250,000.00</p>
            <input type="number" />
            <p>Rs. 250,000.00</p>
